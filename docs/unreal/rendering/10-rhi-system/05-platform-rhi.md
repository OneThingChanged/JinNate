...
![D3D12 클래스 계층](../images/ch09/1617944-20210818142253383-748080745.jpg)

*D3D12RHI 클래스 계층 - FD3D12DynamicRHI, FD3D12Adapter, FD3D12Device, FD3D12CommandContext*
...
![서브패스 동기화](../images/ch09/1617944-20210818142438177-1059482496.jpg)

*서브패스 동기화 - Binning과 Rasterising의 중첩 실행으로 파이프라인 효율 향상*
...
![RenderThread에서 RHI 실행](../images/ch09/1617944-20210818142325783-1517201819.jpg)

*RenderThread에서 FD3D11DynamicRHI::RHIDrawPrimitive 실행 - RHI Thread 비활성화 시*

![RHIThread에서 RHI 실행](../images/ch09/1617944-20210818142331540-1568729612.jpg)

*RHIThread에서 FD3D11DynamicRHI::RHIDrawPrimitive 실행 - RHI Thread 활성화 시*

![프레임 타이밍](../images/ch09/1617944-20210818142346719-1391237522.jpg)

*프레임 타이밍 통계 - RHIT(RHI Thread) 시간이 별도로 표시됨*
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 0;">
  <a href="../04-pipeline-state/" style="text-decoration: none;">← 이전: 04. 파이프라인 스테이트</a>
  <a href="../../10-material-system/" style="text-decoration: none;">다음: Ch.10 머티리얼 시스템 →</a>
</div>

...
![UE4 High Level Architecture](../images/ch09/1617944-20210818142124175-957129590.jpg)

*UE4 고수준 아키텍처 - Game Engine(크로스 플랫폼) → Renderer → RHI(플랫폼 종속)*
...
![RHI 스레딩 타임라인](../images/ch09/1617944-20210818142452260-1791817157.webp)

*Game Thread, Render Thread, RHI Thread, GPU 간의 실행 타임라인과 동기화*
│                                                                 │
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 0;">
  <a href="../08-shader-system/05-shader-optimization/" style="text-decoration: none;">← 이전: Ch.08 05. 셰이더 시스템</a>
  <a href="01-rhi-overview/" style="text-decoration: none;">다음: 01. RHI 개요 →</a>
</div>

...
![RHI 콘솔 변수](../images/ch09/1617944-20210818142311098-1258809611.jpg)

*RHI 관련 콘솔 변수 - r.RHICmdBypass, r.RHIThread.Enable 등*

![콘솔 변수 접근](../images/ch09/1617944-20210818142501110-771482790.jpg)

*UE 에디터에서 Console Variables 접근 (Help → Console Variables)*
...
<div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 0;">
  <a href="../03-command-list/" style="text-decoration: none;">← 이전: 03. 커맨드 리스트</a>
  <a href="../05-platform-rhi/" style="text-decoration: none;">다음: 05. 플랫폼별 RHI →</a>
</div>
